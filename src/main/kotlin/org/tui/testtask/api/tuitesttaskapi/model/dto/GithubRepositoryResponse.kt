...
data class RepositoryResponse(
    ...
    @JsonProperty("has_discussions") var hasDiscussions: Boolean? = null,
...
//    @JsonProperty("license") var license: String? = null,
    ...
    @JsonProperty("web_commit_signoff_required") var webCommitSignoffRequired: Boolean? = null,
    @JsonProperty("topics") var topics: ArrayList<String> = arrayListOf(),
    ...
    @JsonProperty("permissions") var permissions: Permissions? = Permissions()
)

data class Permissions(
    @JsonProperty("admin") var admin: Boolean? = null,
    @JsonProperty("maintain") var maintain: Boolean? = null,
    @JsonProperty("push") var push: Boolean? = null,
    @JsonProperty("triage") var triage: Boolean? = null,
    @JsonProperty("pull") var pull: Boolean? = null
)
